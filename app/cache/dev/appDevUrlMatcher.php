...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/video')) {
            // ct_video_watch
            if (0 === strpos($pathinfo, '/video/watch') && preg_match('#^/video/watch(?:/(?P<id>\\d*))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ct_video_watch')), array (  '_controller' => 'CT\\VideoBundle\\Controller\\VideoController::watchAction',  'id' => 1,));
            }

            // ct_video_upload
            if ($pathinfo === '/video/upload') {
                return array (  '_controller' => 'CT\\VideoBundle\\Controller\\VideoController::uploadAction',  '_route' => 'ct_video_upload',);
            }
            ...
            if (0 === strpos($pathinfo, '/video/idbm_search') && preg_match('#^/video/idbm_search(?:/(?P<query>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ct_video_idbm_search')), array (  '_controller' => 'CT\\VideoBundle\\Controller\\VideoController::idbm_searchAction',  'query' => '',));
            }

            // ct_video_delete
            if (0 === strpos($pathinfo, '/video/delete') && preg_match('#^/video/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ct_video_delete')), array (  '_controller' => 'CT\\VideoBundle\\Controller\\VideoController::deleteAction',));
            }

            // ct_flowplayer_css
            if (0 === strpos($pathinfo, '/video/css/flowplayer') && preg_match('#^/video/css/flowplayer/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_ct_flowplayer_css;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ct_flowplayer_css')), array (  '_controller' => 'CT\\VideoBundle\\Controller\\VideoController::styleAction',));
            }
            not_ct_flowplayer_css:
        ...
        if (0 === strpos($pathinfo, '/user')) {
            // ct_user_addFriend
            if (0 === strpos($pathinfo, '/user/add') && preg_match('#^/user/add(?:/(?P<id>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ct_user_addFriend')), array (  '_controller' => 'CT\\UserBundle\\Controller\\UserController::addFriendAction',  'id' => 1,));
            }

            // ct_user_deleteFriend
            if (0 === strpos($pathinfo, '/user/deleteFriend') && preg_match('#^/user/deleteFriend/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ct_user_deleteFriend')), array (  '_controller' => 'CT\\UserBundle\\Controller\\UserController::deleteFriendAction',));
            }

            // ct_user_search
            if ($pathinfo === '/user/search') {
                return array (  '_controller' => 'CT\\UserBundle\\Controller\\UserController::searchAction',  '_route' => 'ct_user_search',);
            }

            // ct_user_show_friends
            if ($pathinfo === '/user/myfriends') {
                return array (  '_controller' => 'CT\\UserBundle\\Controller\\UserController::showMyFriendsAction',  '_route' => 'ct_user_show_friends',);
            }

            // ct_user_deleteUser
            if (0 === strpos($pathinfo, '/user/deluser') && preg_match('#^/user/deluser/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ct_user_deleteUser')), array (  '_controller' => 'CT\\UserBundle\\Controller\\UserController::deleteUserAction',));
            }
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'ct_application_homepage');
            }
        ...
        if (0 === strpos($pathinfo, '/api')) {
            ...
            if (0 === strpos($pathinfo, '/api/users') && preg_match('#^/api/users/(?P<username>[^/\\.]++)(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_get_user')), array (  '_controller' => 'CT\\UserBundle\\Controller\\UserRestController::getUserAction',  '_format' => 'json',));
            }
            not_api_get_user:
            ...
            if (0 === strpos($pathinfo, '/api/me') && preg_match('#^/api/me(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_get_me')), array (  '_controller' => 'CT\\UserBundle\\Controller\\UserRestController::getMeAction',  '_format' => 'json',));
            }
            not_api_get_me:

...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ct_user.profile.form.type' => 'getCtUser_Profile_Form_TypeService',
            'ct_user.registration.form.type' => 'getCtUser_Registration_Form_TypeService',
            ...
            'ijanki_ftp' => 'getIjankiFtpService',
    ...
    /**
     * Gets the 'ct_user.profile.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CT\UserBundle\Form\Type\ProfileFormType A CT\UserBundle\Form\Type\ProfileFormType instance.
     */
    protected function getCtUser_Profile_Form_TypeService()
    {
        return $this->services['ct_user.profile.form.type'] = new \CT\UserBundle\Form\Type\ProfileFormType();
    }

    /**
     * Gets the 'ct_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CT\UserBundle\Form\Type\RegistrationFormType A CT\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getCtUser_Registration_Form_TypeService()
    {
        return $this->services['ct_user.registration.form.type'] = new \CT\UserBundle\Form\Type\RegistrationFormType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'yodalapute123', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/CT/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/CT/ApplicationBundle/Entity'), 2 => ($this->targetDirs[3].'/src/CT/VideoBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'CT\\UserBundle\\Entity');
        $c->addDriver($b, 'CT\\ApplicationBundle\\Entity');
        $c->addDriver($b, 'CT\\VideoBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('CTUserBundle' => 'CT\\UserBundle\\Entity', 'CTApplicationBundle' => 'CT\\ApplicationBundle\\Entity', 'CTVideoBundle' => 'CT\\VideoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_88e0b710ea77e1d899d99495626283bc6af0c68a84b2a376f4e4ce86dabce61b');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('CT\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'ct_user_profile', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('CT\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'ct_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('CT\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('CT\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'CT\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'ijanki_ftp' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ijanki\Bundle\FtpBundle\Ftp A Ijanki\Bundle\FtpBundle\Ftp instance.
     */
    protected function getIjankiFtpService()
    {
        return $this->services['ijanki_ftp'] = new \Ijanki\Bundle\FtpBundle\Ftp();
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[2].'/serializer/FOSUserBundle'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer'), 'Stof\\DoctrineExtensionsBundle' => ($this->targetDirs[3].'/vendor/stof/doctrine-extensions-bundle/Stof/DoctrineExtensionsBundle/Resources/config/serializer'), 'CT\\UserBundle' => ($this->targetDirs[3].'/src/CT/UserBundle/Resources/config/serializer'), 'CT\\ApplicationBundle' => ($this->targetDirs[3].'/src/CT/ApplicationBundle/Resources/config/serializer'), 'CT\\VideoBundle' => ($this->targetDirs[3].'/src/CT/VideoBundle/Resources/config/serializer'), 'Ijanki\\Bundle\\FtpBundle' => ($this->targetDirs[3].'/vendor/ijanki/ftp-bundle/Ijanki/Bundle/FtpBundle/Resources/config/serializer'), 'Gregwar\\ImageBundle' => ($this->targetDirs[3].'/vendor/gregwar/image-bundle/Gregwar/ImageBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-fixtures-bundle/Doctrine/Bundle/FixturesBundle/Resources/config/serializer')));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'CT\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/video');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/community');
        ...
        $q->setOptions(array('login_path' => 'fos_user_security_login', 'default_target_path' => '/', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c, 1 => $m), 'main', $a, $d), 2 => $p, 3 => $s, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $o, $g, $a, $d, true), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5532c1a18f129', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $n, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $n, 'fos_user_security_login', false), NULL, NULL, $a));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/CT/UserBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/CT/ApplicationBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/CT/VideoBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('app_locale', 'fr');
        $instance->addGlobal('web_path', '/thecoontube/web');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CT/UserBundle/Resources/views'), 'CTUser');
        $instance->addPath(($this->targetDirs[3].'/src/CT/ApplicationBundle/Resources/views'), 'CTApplication');
        $instance->addPath(($this->targetDirs[3].'/src/CT/VideoBundle/Resources/views'), 'CTVideo');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CTUserBundle' => 'CT\\UserBundle\\CTUserBundle',
                'CTApplicationBundle' => 'CT\\ApplicationBundle\\CTApplicationBundle',
                'CTVideoBundle' => 'CT\\VideoBundle\\CTVideoBundle',
                'IjankiFtpBundle' => 'Ijanki\\Bundle\\FtpBundle\\IjankiFtpBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'yodalapute123',
            ...
            'web_path' => '/thecoontube/web',
            'ftp_login_url' => 'ftp://thecoon:yodalapute123@127.0.0.1',
            ...
            'fos_user.model.user.class' => 'CT\\UserBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'ct_user_profile',
            ...
            'fos_user.registration.form.type' => 'ct_user_registration',
            ...
            'ijanki_ftp.class' => 'Ijanki\\Bundle\\FtpBundle\\Ftp',

 ...
 */
class Post extends \CT\ApplicationBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CT\\ApplicationBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'CT\\ApplicationBundle\\Entity\\Post' . "\0" . 'community', '' . "\0" . 'CT\\ApplicationBundle\\Entity\\Post' . "\0" . 'comments', '' . "\0" . 'CT\\ApplicationBundle\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'CT\\ApplicationBundle\\Entity\\Post' . "\0" . 'content', '' . "\0" . 'CT\\ApplicationBundle\\Entity\\Post' . "\0" . 'date', '' . "\0" . 'CT\\ApplicationBundle\\Entity\\Post' . "\0" . 'video');
        }
